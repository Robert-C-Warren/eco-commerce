...
const availableIcons = [
	...
	},
	{
		...
		src: fla,
		title: "Fair Labor Association Member",
	},
	...
	{
		id: "social_accountability_international",
		label: "Social Accountability International (SAI)",
		src: sai,
	...
	{
		id: "RAINN_logo",
		label: "RAINN (Rape, Abuse & Incest National Network)",
		src: RAINN,
		title: "RAINN",
	},
	{
		id: "One_Tree_Planted_Logo",
	...
	{
		id: "Peruvian_Hearts_logo",
		label: "Peruvian Hearts",
		src: peruvianHearts,
		title: "Peruvian Hearts",
	},
	{
		id: "SeaLegacy_logo",
		label: "SeaLegacy",
	...
	{
		id: "jetty_rock_foundation_logo",
		label: "Jetty Rock Foundation",
		src: jettyrockfoundation,
		title: "Jetty Rock Foundation",
	},
	{
		id: "epa_green_power_logo",
		label: "EPA Green Power Partner",
		src: epagreenpower,
		title: "EPA Green Power Partner",
	},
	{
		id: "asbc_logo",
		label: "ASBC (American Sustainable Business Council)",
		src: asbc,
		title: "ASBC",
	},
	{
		id: "cruelty_free_logo",
		label: "Cruelty Free",
		src: crueltyFree,
		title: "Cruelty Free",
	},
	...
	{
		id: "fsc_logo",
		label: "FSC (Forest Stewardship Council) Certified",
		src: fscLogo,
		title: "fsc",
	},
	{
		id: "rainforest_alliance_logo",
		label: "Rainforest Alliance Certified",
		src: rainforestAlliance,
		title: "Rainforest Alliance",
	},
	{
		id: "ewg_logo",
		label: "EWG (Environmental Working Group) Verified",
		src: ewg,
		title: "EWG",
	},
	{
		id: "nongmo_logo",
		label: "Non-GMO Project Certified",
		src: nongmo,
		title: "nongmo",
	},
	{
		id: "greenamerica_logo",
		label: "Green America Certified",
		src: greenAmerica,
		title: "Green America",
	},
	{
		id: "safe_cosmetics_logo",
		label: "Safe Cosmetics Certified",
		src: safecosmetics,
		title: "Safe Cosmetics",
	},
	{
		id: "reef_safe_logo",
		label: "Reef-Safe Certified",
		src: reefsafe,
		title: "Reef Safe",
	},
	{
	...
	{
		id: "msc_logo",
		label: "MSC (Marine Stewardship Council) Certified",
		src: MSC,
		title: "MSC",
	},
	{
		id: "bap_logo",
		label: "BAP (Best Aquaculture Practices) Certified",
		src: BAP,
		title: "BAP",
	},
	{
		id: "grs_logo",
		label: "GRS (Global Recycling Standard) Certified",
		src: GRS,
		title: "GRS",
	},
	{
		id: "wfto_logo",
		label: "WFTO (World Fair Trade Organization) Guaranteed",
		src: WFTO,
		title: "WFTO",
	},
	{
		id: "lwg_logo",
		label: "LWG (Leather Working Group) Gold Certification",
		src: LWG,
		title: "LWG",
	},
	{
		id: "fla_logo",
		label: "FLA (Fair Labor Association) Accredidation",
		src: FLA,
		title: "FLA",
	},
	{
		id: "sca_logo",
		label: "SCA (Specialty Coffee Association) Standards",
		src: SCA,
		title: "SCA",
	},
	{
		id: "psc_logo",
		label: "PSC (Pet Sustainability Coalition) Member",
		src: PSC,
		title: "PSC",
	},
	{
		id: "fair_wear_logo",
		label: "Fair Wear Foundation Member",
		src: fairWear,
		title: "Fair Wear",
	},
	{
		id: "scs_global_logo",
		label: "SCS Global Zero-Waste-to-Landfill",
		src: scsGlobal,
		title: "SCS Global",
	},
	{
		id: "sdg_logo",
		label: "SDGs (Sustainable Development Goals) Alignment",
		src: SDG,
		title: "SDG",
	},
	{
		id: "global_good_logo",
		label: "Global Good Awards Recognition",
		src: globalGood,
		title: "Global Good",
	},
	{
		id: "solar_aid_logo",
		label: "SolarAid Partnership Certification",
		src: SolarAid,
		title: "SolarAid",
	},
	...
	{
		id: "real_seal_logo",
		label: "REAL Seal Certification",
		src: realSeal,
		title: "realSeal",
	},
	{
		id: "dfa_logo",
		label: "Dairy Farmers of America (DFA) Membership",
		src: DFA,
		title: "DFA",
	},
	{
		id: "gap_logo",
		label: "Global Animal Partnership (GAP) Certification",
		src: GAP,
		title: "GAP",
	},
	{
		id: "certified_humane_logo",
	...
	{
		id: "ocean_cycle_logo",
		label: "OceanCycle Certification",
		src: oceanCycle,
		title: "OceanCycle",
	},
	{
	...
	{
		id: "made_safe_logo",
		label: "MADE SAFE Certified",
		src: madeSafe,
		title: "MADE SAFE",
	},
	{
		id: "nsf_ansi_logo",
		label: "NSF/ANSI International Standards Compliance",
		src: nsfansi,
		title: "nsfansi",
	},
	{
		id: "wrap_logo",
		label: "Worldwide Responsible Accredited Production (WRAP) Certification",
		src: WRAP,
		title: "WRAP",
	},
	{
		id: "iso_logo",
		label: "ISO 14001 Environmental Management Certified",
		src: ISO,
		title: "ISO",
	},
	{
		id: "swa_logo",
		label: "Member of the Scotch Whisky Association's Environmental Charter",
		src: SWA,
		title: "SWA",
	},
	{
		id: "soil_logo",
		label: "Certified Organic by the Soil Association",
		src: soil,
		title: "Soil Association",
	},
	{
		id: "napa_green_logo",
		label: "Napa Green Certified Winery",
		src: napaGreen,
		title: "Napa Green",
	},
	{
		id: "sustainable_winegrowing_logo",
		label: "Sustainable Winegrowing Certification",
		src: CSWA,
		title: "Sustainable Winegrowing",
	},
	{
		id: "oeko_tex_logo",
	...
	{
		id: "100%_agave_logo",
		label: "Certified 100% Agave Tequila",
		src: Agave,
		title: "Agave",
	},
	{
		id: "mcs_logo",
		label: "Recognized by the Marine Conservation Society",
		src: MCS,
		title: "MSC",
	},
	{
		id: "jpma_logo",
		label: "Juvenile Products Manufacturers Association (JPMA)",
		src: jpma,
		title: "jpma",
	},
	{
		id: "carbon_neutral_logo",
		label: "Certified Carbon-Neutral",
		src: carbonNeutral,
		title: "Carbon Neutral",
	},
	{
		id: "usda_organic_logo",
		label: "USDA Organic Certification",
		src: usdaOrganic,
		title: "USDA Organic",
	},
	{
		id: "craft_distillery_logo",
		label: "Certified Craft Distillery",
		src: craftDistillery,
		title: "Craft Distillery",
	},
	{
		id: "ecoboard_logo",
		label: "ECOBOARD Project Certified",
		src: ecoboard,
		title: "ecoboard logo",
	},
	{
		id: "gia_logo",
		label: "GIA (Gemological Institute of America) Certified lab-grown diamonds",
		src: GIA,
		title: "GIA",
	},
	{
		id: "rjc_logo",
		label: "Responsible Jewellery Council (RJC) Member",
		src: RJC,
		title: "RJC",
	},
	{
		id: "ccib_logo",
		label: "Member of the Canadian Council for Aboriginal Business",
		src: CCIB,
		title: "CCIB",
	},
	{
	...
	{
		id: "blue_angel_logo",
		label: "Blue Angel Certification",
		src: blueAngel,
		title: "Blue Angel",
	},
	...
	{
		id: "sfc_logo",
		label: "Sustainable Furnishings Council (SFC) Member",
		src: sfc,
		title: "SFC",
	},
	{
		id: "nasc_logo",
		label: "Certified by National Animal Supplement Council (NASC)",
		src: nasc,
		title: "NASC",
	},
	{
		id: "bpi_logo",
		label: "BPI (Biodegradable Products Institute) Certified",
		src: BPI,
		title: "BPI",
	},
	{
		id: "ok_compost_logo",
		label: "OK Compost Certified",
		src: okCompost,
		title: "OK Compost",
	},
	{
		id: "floristry_logo",
		label: "Sustainable Floristry Certification",
		src: floristry,
		title: "floristry",
	},
	{
		id: "live_logo",
		label: "LIVE Certified Sustainable",
		src: LIVE,
		title: "LIVE",
	},
	{
		id: "salmon_safe_logo",
		label: "Salmon-Safe Certified",
		src: salmonSafe,
		title: "Salmon Safe",
	},
	{
		id: "omri_logo",
		label: "OMRI (Organic Materials Review Institute) Listed",
		src: OMRI,
		title: "OMRI",
	},
	...
	{
		id: "pdo_logo",
		label: "Protected Designation of Origin (PDO) Certified",
		src: PDO,
		title: "PDO",
	},
	{
		id: "nff_logo",
		label: "National Forest Foundation",
		src: NFF,
		title: "NFF",
	},
	{
		id: "climate_neutral_logo",
		label: "Climate Neutral Certified",
		src: climateNeutral,
		...
		<div>
			<div className="container my-4">
				<Helmet>
					...
					<meta
						name="keywords"
						content={`${categoryName}, EcoCommerce, sustainable, eco-friendly, responsible shopping, ethical brands, 
				...
				<div className="hero-section text-center p-5">
					...
					<p className="lead">
						The companies listed below are dedicated to making a positive impact on our planet.
						<br />
						They prioritize treating their employees with respect and dignity while ensuring
						<br />
				...
				<div className="row">
					{companies.map((company, index) => (
						<div key={index} className={`card-group col-lg-3 col-md-6 col-sm-12 ${expandedCompany === company._id ? "position-relative" : ""}`}>
							<div ref={expandedCompany === company._id ? cardRef : null} className={`card company-card ${expandedCompany === company._id ? "expanded" : "collapsed"}`} onPointerMove={handleMouseMove}>
								...
								{expandedCompany === company._id && (
									<div className="card-body-category">
										...
										<div className="company-links-container">
											<a href={company.website} className="btn btn-primary visit-site-btn" target="_blank" rel="noopener noreferrer">
												Visit Website
											</a>
										</div>
										...
										<div className="icon-wrapper">
											...
											<div className="d-flex justify-content-center align-items-center center-container flex-grow-1">
												...
												<h2
													...
													style={{
														color: getScoreColor(company.transparency_score),
													}}>
													{company.transparency_score} {getScoreRating(company.transparency_score)}
												</h2>
											</div>
