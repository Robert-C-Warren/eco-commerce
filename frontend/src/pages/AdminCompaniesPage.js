    ...
    if (selectedFile) {
      try {
        ...
        const storageRef = ref(
          storage,
          `logos/${Date.now()}_${selectedFile.name}`
        );
    ...
    <div className={`company-card ${expanded ? "expanded" : "collapsed"}`}>
      ...
      {expanded && (
        <div className="company-details card-content">
          ...
          <p>
            <strong>QualificationsL</strong>{" "}
            {Array.isArray(company.qualifications)
              ? company.qualifications.join(", ")
              : company.qualifications}
          </p>
          <p>
          ...
          <button
            ...
            onClick={() => deleteCompanyMutation.mutate(company._id)}
          >
            Delete
          </button>
          {/* Done Button */}
                  ...
                  <div className="modal-body">
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          name="description"
                          className="form-control company-description-modal"
                          value={formData.description}
                          onChange={handleChange}
                          required
                        />
...
const AdminCompaniesPage = () => {
  ...
  return (
    <div className="container-fluid my-4">
      <ToastContainer />
      <h1 className="text-center mb-4 admin-manage-companies">
