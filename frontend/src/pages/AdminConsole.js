...
const AdminConsole = () => {
        ...
        try {
            ...
            response.data.forEach(group => {
                if (group._id && Array.isArray(group.products)) {
                    formattedProducts[group._id] = group.products;
                } else {
            ...
            console.error("Error fetching grouped products:", error.response ? error.response.data : error);
        }
    };
    ...
    const addProduct = async () => {
        try {
            ...
            setNewProduct({ title: "", description: "", image: "", company: "", category: "" });
            setSelectedCompany("")
            fetchProducts()
        } catch (error) {
